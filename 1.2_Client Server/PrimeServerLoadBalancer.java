...
public class PrimeServerLoadBalancer extends Thread{
    private final static int PORT = 9090;
    private final static Logger LOGGER = Logger.getLogger(PrimeServerLoadBalancer.class.getName());
    ...
    PrimeServerLoadBalancer(int port) {
...
//        }
        ...
        new PrimeServerLoadBalancer(port).listen();
    }
}
